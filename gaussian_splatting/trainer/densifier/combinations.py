...
from .densifier import SplitCloneDensifierWrapper, SplitCloneDensifierTrainerWrapper
from .adaptive import AdaptiveSplitCloneDensifierWrapper, AdaptiveSplitCloneDensifierTrainerWrapper
from .pruner import OpacityPruner, OpacityPrunerDensifierWrapper


def FullDensifierWrapper(model: GaussianModel, scene_extent: float, *args, **kwargs) -> AbstractDensifier:
    return OpacityPrunerDensifierWrapper(
        SplitCloneDensifierWrapper,
        model, scene_extent,
        *args, **kwargs
    )


def FullAdaptiveDensifierWrapper(model: GaussianModel, scene_extent: float, *args, **kwargs) -> AbstractDensifier:
    return OpacityPrunerDensifierWrapper(
        AdaptiveSplitCloneDensifierWrapper,
        model, scene_extent,
        *args, **kwargs
    )
